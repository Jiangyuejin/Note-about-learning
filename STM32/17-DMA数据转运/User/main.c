...
uint8_t DataB[] = {0, 0, 0, 0};                     //定义测试数组DataB，为数据源目的地
...
int main (void)
{
    ...
    OLED_ShowString(1, 1, "DataA"); //  1行1列显示字符串
    OLED_ShowString(3, 1, "DataB"); //  3行1列显示字符串
